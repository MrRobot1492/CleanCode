...
{
    //regularPay
    //RIGHT MOUSE BUTTON, YELLOW SPOTLIGHT,SELECT VARIABLE, REMOVE REDUNDANT ASSIGNEMENT, JOIN DECLARATION AND ASSIGNEMENT

    //overtimePay
    //MOVE IT MANUALLY SINCE IT DEPENDS ON ANOTHER VARIABLE

    //DECLARE THE VARIABLES CLOSE THEIR USAGE
