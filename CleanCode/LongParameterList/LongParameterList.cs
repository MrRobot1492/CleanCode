...
{
    //MAXIMUM THREE INPUT PARAMETERS
    //TRY TO REUSE THE EXISTING CLASSES AS MUCH AS POSSIBLE
    //REFACTOR, EXTRACT, TRANSFORM PARAMETERS
    ...
    public class LongParameterList
    {
        ...
        public void CreateReservation(DateRange dateRange)
        {
            if (dateRange.DateFrom >= DateTime.Now)
                throw new ArgumentNullException("dateFrom");
            if (dateRange.DateTo <= DateTime.Now)
